...
class EditScheduledTransactionScreenState {
  ...
  factory EditScheduledTransactionScreenState.initial() =>
      EditScheduledTransactionScreenState(
  ...
  EditScheduledTransactionScreenState copyWith({
    ...
    return EditScheduledTransactionScreenState(
