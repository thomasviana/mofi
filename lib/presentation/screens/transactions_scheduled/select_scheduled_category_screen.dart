...
class SelectScheduledCategoryScreen extends StatefulWidget {
  const SelectScheduledCategoryScreen({
    Key? key,
  }) : super(key: key);
  @override
  _SelectScheduledCategoryScreenState createState() =>
      _SelectScheduledCategoryScreenState();
}

class _SelectScheduledCategoryScreenState
    extends State<SelectScheduledCategoryScreen>
        ...
        return ListView(
          ...
          children: [
            ...
            ListTile(
              ...
              onTap: () {
                context.read<EditScheduledTransactionScreenBloc>().add(
                      SubCategorySelected(
