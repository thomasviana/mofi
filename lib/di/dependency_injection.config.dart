...
import '../core/accounts/src/application/update_account.dart' as _i78;
...
import '../core/budgets/src/application/back_up_budgets.dart' as _i88;
...
import '../core/budgets/src/application/update_budget.dart' as _i79;
...
import '../core/categories/src/application/back_up_categories.dart' as _i89;
import '../core/categories/src/application/create_category.dart' as _i33;
import '../core/categories/src/application/create_sub_category.dart' as _i93;
import '../core/categories/src/application/delete_category.dart' as _i37;
import '../core/categories/src/application/delete_sub_category.dart' as _i95;
import '../core/categories/src/application/get_categories.dart' as _i52;
import '../core/categories/src/application/get_sub_categories.dart' as _i98;
import '../core/categories/src/application/reset_categories.dart' as _i102;
...
import '../core/categories/src/application/set_default_sub_categories.dart'
    as _i103;
import '../core/categories/src/application/update_category.dart' as _i80;
import '../core/categories/src/application/update_sub_category.dart' as _i81;
...
import '../core/transactions/src/application/add_transaction.dart' as _i85;
import '../core/transactions/src/application/delete_transaction.dart' as _i96;
import '../core/transactions/src/application/get_transactions.dart' as _i99;
import '../core/transactions/src/application/update_transaction.dart' as _i82;
...
import '../core/user/domain.dart' as _i86;
import '../core/user/src/application/check_auth_status.dart' as _i92;
import '../core/user/src/application/create_user.dart' as _i94;
import '../core/user/src/application/get_is_first_time_open.dart' as _i107;
import '../core/user/src/application/get_profile_info.dart' as _i97;
import '../core/user/src/application/log_out.dart' as _i100;
...
import '../core/user/src/application/set_is_first_time_open_false.dart'
    as _i104;
import '../core/user/src/application/sign_in.dart' as _i105;
import '../core/user/src/application/update_user_info.dart' as _i106;
import '../core/user/src/infrastructure/auth/auth_service_impl.dart' as _i87;
...
import '../presentation/screens/transactions/manage_income_bloc/manage_income_screen_bloc.dart'
    as _i57;
import 'db_injectable_module.dart' as _i108;
import 'firebase_injectable_module.dart' as _i109;
import 'image_picker_injectable_module.dart' as _i110;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i76.TransactionsBloc>(() => _i76.TransactionsBloc(
      get<_i46.GetTransactions>(), get<_i46.DeleteTransaction>()));
  gh.lazySingleton<_i75.TransactionsDatabase>(
      () => dbInjectableModule.transctionsDatabase);
  gh.lazySingleton<_i77.TransactionsLocalDataSource>(() =>
      _i77.TransactionsLocalDataSourceImpl(
          get<_i75.TransactionDao>(), get<_i75.TransactionMapper>()));
  gh.factory<_i78.UpdateAccount>(() => _i78.UpdateAccount(
      get<_i6.AccountRepository>(), get<_i50.GetAccounts>()));
  gh.factory<_i79.UpdateBudget>(() =>
      _i79.UpdateBudget(get<_i18.BudgetRepository>(), get<_i41.GetBudgets>()));
  gh.factory<_i80.UpdateCategory>(() => _i80.UpdateCategory(
      get<_i29.CategoryRepository>(), get<_i43.GetCategories>()));
  gh.factory<_i81.UpdateSubCategory>(() => _i81.UpdateSubCategory(
      get<_i29.SubCategoryRepository>(), get<_i43.GetSubCategories>()));
  gh.factory<_i82.UpdateTransaction>(() => _i82.UpdateTransaction(
      get<_i73.TransactionRepository>(), get<_i46.GetTransactions>()));
  gh.lazySingleton<_i83.UserFirebaseProvider>(() => _i83.UserFirebaseProvider(
      get<_i49.FirebaseStorage>(), get<_i48.FirebaseFirestore>()));
  gh.lazySingleton<_i84.AccountsFirebaseProvider>(
      () => _i84.AccountsFirebaseProvider(get<_i48.FirebaseFirestore>()));
  gh.factory<_i85.AddTransaction>(() => _i85.AddTransaction(
      get<_i73.TransactionRepository>(), get<_i12.GetProfileInfo>()));
  gh.lazySingleton<_i86.AuthService>(() => _i87.AuthServiceImpl(
      get<_i47.FirebaseAuth>(),
      get<_i53.GoogleSignIn>(),
      get<_i83.UserFirebaseProvider>()));
  gh.factory<_i88.BackUpBudgets>(() => _i88.BackUpBudgets(
      get<_i12.GetProfileInfo>(), get<_i18.BudgetRepository>()));
  gh.factory<_i89.BackUpCategories>(() => _i89.BackUpCategories(
      get<_i12.GetProfileInfo>(), get<_i29.CategoryRepository>()));
  gh.lazySingleton<_i90.BudgetsFirebaseProvider>(
      () => _i90.BudgetsFirebaseProvider(get<_i48.FirebaseFirestore>()));
  gh.lazySingleton<_i91.CategoriesFirebaseProvider>(
      () => _i91.CategoriesFirebaseProvider(get<_i48.FirebaseFirestore>()));
  gh.factory<_i92.CheckAuthStatus>(
      () => _i92.CheckAuthStatus(get<_i86.AuthService>()));
  gh.factory<_i93.CreateSubCategory>(
      () => _i93.CreateSubCategory(get<_i29.SubCategoryRepository>()));
  gh.factory<_i94.CreateUser>(() => _i94.CreateUser(get<_i86.AuthService>()));
  gh.factory<_i95.DeleteSubCategory>(
      () => _i95.DeleteSubCategory(get<_i29.SubCategoryRepository>()));
  gh.factory<_i96.DeleteTransaction>(
      () => _i96.DeleteTransaction(get<_i73.TransactionRepository>()));
  gh.factory<_i97.GetProfileInfo>(
      () => _i97.GetProfileInfo(get<_i86.AuthService>()));
  gh.factory<_i98.GetSubCategories>(
      () => _i98.GetSubCategories(get<_i29.SubCategoryRepository>()));
  gh.factory<_i99.GetTransactions>(() => _i99.GetTransactions(
      get<_i73.TransactionRepository>(), get<_i12.GetProfileInfo>()));
  gh.factory<_i100.LogOut>(() => _i100.LogOut(get<_i86.AuthService>()));
  gh.lazySingleton<_i86.PreferencesService>(
      () => _i101.ImplPreferencesService(get<_i66.SharedPreferences>()));
  gh.factory<_i102.ResetCategories>(() => _i102.ResetCategories(
      get<_i29.CategoryRepository>(), get<_i29.SubCategoryRepository>()));
  gh.factory<_i103.SetDefaultSubCategories>(
      () => _i103.SetDefaultSubCategories(get<_i29.SubCategoryRepository>()));
  gh.factory<_i104.SetFirstTimeOpenToFalse>(
      () => _i104.SetFirstTimeOpenToFalse(get<_i86.PreferencesService>()));
  gh.factory<_i105.SignIn>(() => _i105.SignIn(get<_i86.AuthService>()));
  gh.factory<_i106.UpdateUserInfo>(
      () => _i106.UpdateUserInfo(get<_i86.AuthService>()));
  gh.factory<_i107.GetIsFirstTimeOpen>(
      () => _i107.GetIsFirstTimeOpen(get<_i86.PreferencesService>()));
  return get;
}

class _$DbInjectableModule extends _i108.DbInjectableModule {}

class _$FirebaseInjectableModule extends _i109.FirebaseInjectableModule {}

class _$ImagePickerInjectableModule extends _i110.ImagePickerInjectableModule {}

class _$PreferencesInjectableModule extends _i111.PreferencesInjectableModule {}
