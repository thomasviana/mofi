...
import 'package:shared_preferences/shared_preferences.dart' as _i71;
...
import '../core/accounts/src/application/set_default_accounts.dart' as _i67;
import '../core/accounts/src/application/update_account.dart' as _i83;
...
import '../core/budgets/src/application/back_up_budgets.dart' as _i93;
...
import '../core/budgets/src/application/set_default_budgets.dart' as _i68;
import '../core/budgets/src/application/update_budget.dart' as _i84;
...
import '../core/categories/src/application/back_up_categories.dart' as _i94;
import '../core/categories/src/application/create_category.dart' as _i33;
import '../core/categories/src/application/create_sub_category.dart' as _i99;
import '../core/categories/src/application/delete_category.dart' as _i38;
import '../core/categories/src/application/delete_sub_category.dart' as _i101;
import '../core/categories/src/application/get_categories.dart' as _i54;
import '../core/categories/src/application/get_sub_categories.dart' as _i105;
import '../core/categories/src/application/reset_categories.dart' as _i109;
import '../core/categories/src/application/set_default_categories.dart' as _i69;
import '../core/categories/src/application/set_default_sub_categories.dart'
    as _i112;
import '../core/categories/src/application/update_category.dart' as _i85;
import '../core/categories/src/application/update_sub_category.dart' as _i86;
...
import '../core/transactions/domain.dart' as _i76;
import '../core/transactions/infrastructure.dart' as _i78;
import '../core/transactions/src/application/add_transaction.dart' as _i90;
import '../core/transactions/src/application/back_up_transactions.dart' as _i95;
import '../core/transactions/src/application/delete_transaction.dart' as _i102;
import '../core/transactions/src/application/get_scheduled_transactions.dart'
    as _i104;
import '../core/transactions/src/application/get_transactions.dart' as _i106;
import '../core/transactions/src/application/reset_transactions.dart' as _i110;
import '../core/transactions/src/application/schedule_transaction.dart'
    as _i111;
import '../core/transactions/src/application/update_transaction.dart' as _i87;
...
import '../core/user/domain.dart' as _i91;
import '../core/user/src/application/check_auth_status.dart' as _i98;
import '../core/user/src/application/create_user.dart' as _i100;
import '../core/user/src/application/get_is_first_time_open.dart' as _i116;
import '../core/user/src/application/get_profile_info.dart' as _i103;
import '../core/user/src/application/log_out.dart' as _i107;
...
import '../core/user/src/application/set_is_first_time_open_false.dart'
    as _i113;
import '../core/user/src/application/sign_in.dart' as _i114;
import '../core/user/src/application/update_user_info.dart' as _i115;
import '../core/user/src/infrastructure/auth/auth_service_impl.dart' as _i92;
...
import '../presentation/core/settings/settings_bloc.dart' as _i70;
import '../presentation/core/stats/stats_bloc.dart' as _i72;
import '../presentation/core/transactions/transactions_bloc.dart' as _i79;
...
import '../presentation/screens/profile/profile_screen_bloc/profile_sceen_bloc.dart'
    as _i61;
import '../presentation/screens/transactions/edit_scheduled_transaction_bloc/edit_scheduled_transaction_screen_bloc.dart'
    as _i45;
...
import '../presentation/screens/transactions/manage_income_bloc/manage_income_screen_bloc.dart'
    as _i59;
import 'db_injectable_module.dart' as _i117;
import 'firebase_injectable_module.dart' as _i119;
import 'packages_injectable_module.dart' as _i118;
import 'preferences_injectable_module.dart'
    as _i120; // ignore_for_file: unnecessary_lambdas
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i67.SetDefaultAccounts>(() => _i67.SetDefaultAccounts(
      get<_i12.GetProfileInfo>(), get<_i6.AccountRepository>()));
  gh.factory<_i68.SetDefaultBudgets>(() => _i68.SetDefaultBudgets(
      get<_i18.BudgetRepository>(), get<_i12.GetProfileInfo>()));
  gh.factory<_i69.SetDefaultCategories>(() => _i69.SetDefaultCategories(
      get<_i12.GetProfileInfo>(), get<_i29.CategoryRepository>()));
  gh.factory<_i70.SettingsBloc>(() => _i70.SettingsBloc(
  ...
  await gh.factoryAsync<_i71.SharedPreferences>(
      () => preferencesInjectableModule.preferences,
      preResolve: true);
  gh.factory<_i72.StatsBloc>(() => _i72.StatsBloc(
      get<_i12.GetIsFirstTimeOpen>(),
      get<_i12.SetFirstTimeOpenToFalse>(),
      get<_i42.GetBudgets>(),
      get<_i44.GetCategories>(),
  ...
  gh.lazySingleton<_i73.SubCategoryMapper>(() => _i73.SubCategoryMapper());
  gh.lazySingleton<_i29.SubCategoryRepository>(() =>
      _i74.SubCategoryRepositoryImpl(get<_i23.CategoriesLocalDataSource>(),
          get<_i23.CategoriesRemoteDataSource>()));
  gh.lazySingleton<_i64.TransactionDao>(
      () => _i64.TransactionDao(get<_i65.TransactionsDatabase>()));
  gh.lazySingleton<_i75.TransactionMapper>(() => _i75.TransactionMapper());
  gh.lazySingleton<_i76.TransactionRepository>(() =>
      _i77.TransactionRepositoryImpl(get<_i78.TransactionsLocalDataSource>(),
          get<_i78.TransactionsRemoteDataSource>()));
  gh.factory<_i79.TransactionsBloc>(() => _i79.TransactionsBloc(
      get<_i12.GetIsFirstTimeOpen>(),
      get<_i46.GetTransactions>(),
      get<_i46.DeleteTransaction>(),
      get<_i46.BackUpTransactions>()));
  gh.lazySingleton<_i78.TransactionsDatabase>(
      () => dbInjectableModule.transctionsDatabase);
  gh.lazySingleton<_i80.TransactionsFirebaseProvider>(
      () => _i80.TransactionsFirebaseProvider(get<_i50.FirebaseFirestore>()));
  gh.lazySingleton<_i81.TransactionsLocalDataSource>(() =>
      _i81.TransactionsLocalDataSourceImpl(
          get<_i78.TransactionDao>(),
          get<_i78.ScheduledTransactionDao>(),
          get<_i78.TransactionMapper>(),
          get<_i78.ScheduledTransactionMapper>()));
  gh.lazySingleton<_i82.TransactionsRemoteDataSource>(() =>
      _i82.TransactionsRemoteDataSourceImpl(
          get<_i78.TransactionsFirebaseProvider>()));
  gh.factory<_i83.UpdateAccount>(() => _i83.UpdateAccount(
      get<_i6.AccountRepository>(), get<_i52.GetAccounts>()));
  gh.factory<_i84.UpdateBudget>(() =>
      _i84.UpdateBudget(get<_i18.BudgetRepository>(), get<_i42.GetBudgets>()));
  gh.factory<_i85.UpdateCategory>(() => _i85.UpdateCategory(
      get<_i29.CategoryRepository>(), get<_i44.GetCategories>()));
  gh.factory<_i86.UpdateSubCategory>(() => _i86.UpdateSubCategory(
      get<_i29.SubCategoryRepository>(), get<_i44.GetSubCategories>()));
  gh.factory<_i87.UpdateTransaction>(() => _i87.UpdateTransaction(
      get<_i76.TransactionRepository>(), get<_i46.GetTransactions>()));
  gh.lazySingleton<_i88.UserFirebaseProvider>(() => _i88.UserFirebaseProvider(
      get<_i51.FirebaseStorage>(), get<_i50.FirebaseFirestore>()));
  gh.lazySingleton<_i89.AccountsFirebaseProvider>(
      () => _i89.AccountsFirebaseProvider(get<_i50.FirebaseFirestore>()));
  gh.factory<_i90.AddTransaction>(() => _i90.AddTransaction(
      get<_i76.TransactionRepository>(), get<_i12.GetProfileInfo>()));
  gh.lazySingleton<_i91.AuthService>(() => _i92.AuthServiceImpl(
      get<_i49.FirebaseAuth>(),
      get<_i55.GoogleSignIn>(),
      get<_i88.UserFirebaseProvider>()));
  gh.factory<_i93.BackUpBudgets>(() => _i93.BackUpBudgets(
      get<_i12.GetProfileInfo>(), get<_i18.BudgetRepository>()));
  gh.factory<_i94.BackUpCategories>(() => _i94.BackUpCategories(
      get<_i12.GetProfileInfo>(), get<_i29.CategoryRepository>()));
  gh.factory<_i95.BackUpTransactions>(() => _i95.BackUpTransactions(
      get<_i12.GetProfileInfo>(), get<_i76.TransactionRepository>()));
  gh.lazySingleton<_i96.BudgetsFirebaseProvider>(
      () => _i96.BudgetsFirebaseProvider(get<_i50.FirebaseFirestore>()));
  gh.lazySingleton<_i97.CategoriesFirebaseProvider>(
      () => _i97.CategoriesFirebaseProvider(get<_i50.FirebaseFirestore>()));
  gh.factory<_i98.CheckAuthStatus>(
      () => _i98.CheckAuthStatus(get<_i91.AuthService>()));
  gh.factory<_i99.CreateSubCategory>(
      () => _i99.CreateSubCategory(get<_i29.SubCategoryRepository>()));
  gh.factory<_i100.CreateUser>(() => _i100.CreateUser(get<_i91.AuthService>()));
  gh.factory<_i101.DeleteSubCategory>(
      () => _i101.DeleteSubCategory(get<_i29.SubCategoryRepository>()));
  gh.factory<_i102.DeleteTransaction>(
      () => _i102.DeleteTransaction(get<_i76.TransactionRepository>()));
  gh.factory<_i103.GetProfileInfo>(
      () => _i103.GetProfileInfo(get<_i91.AuthService>()));
  gh.factory<_i104.GetScheduledTransactions>(() =>
      _i104.GetScheduledTransactions(
          get<_i76.TransactionRepository>(), get<_i12.GetProfileInfo>()));
  gh.factory<_i105.GetSubCategories>(
      () => _i105.GetSubCategories(get<_i29.SubCategoryRepository>()));
  gh.factory<_i106.GetTransactions>(() => _i106.GetTransactions(
      get<_i76.TransactionRepository>(), get<_i12.GetProfileInfo>()));
  gh.factory<_i107.LogOut>(() => _i107.LogOut(get<_i91.AuthService>()));
  gh.lazySingleton<_i91.PreferencesService>(
      () => _i108.ImplPreferencesService(get<_i71.SharedPreferences>()));
  gh.factory<_i109.ResetCategories>(() => _i109.ResetCategories(
      get<_i29.CategoryRepository>(), get<_i29.SubCategoryRepository>()));
  gh.factory<_i110.ResetTransactions>(
      () => _i110.ResetTransactions(get<_i76.TransactionRepository>()));
  gh.factory<_i111.ScheduleTransaction>(() => _i111.ScheduleTransaction(
      get<_i76.TransactionRepository>(),
      get<_i12.GetProfileInfo>(),
      get<_i34.Cron>()));
  gh.factory<_i112.SetDefaultSubCategories>(
      () => _i112.SetDefaultSubCategories(get<_i29.SubCategoryRepository>()));
  gh.factory<_i113.SetFirstTimeOpenToFalse>(
      () => _i113.SetFirstTimeOpenToFalse(get<_i91.PreferencesService>()));
  gh.factory<_i114.SignIn>(() => _i114.SignIn(get<_i91.AuthService>()));
  gh.factory<_i115.UpdateUserInfo>(
      () => _i115.UpdateUserInfo(get<_i91.AuthService>()));
  gh.factory<_i116.GetIsFirstTimeOpen>(
      () => _i116.GetIsFirstTimeOpen(get<_i91.PreferencesService>()));
  return get;
}

class _$DbInjectableModule extends _i117.DbInjectableModule {}

class _$PackagesInjectableModule extends _i118.PackagesInjectableModule {}

class _$FirebaseInjectableModule extends _i119.FirebaseInjectableModule {}

class _$PreferencesInjectableModule extends _i120.PreferencesInjectableModule {}
